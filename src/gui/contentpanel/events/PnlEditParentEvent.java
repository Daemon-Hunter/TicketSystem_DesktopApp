            ...
            if (event.setName(txtName.getText())) {
                ...
                if (event.setDescription(txtDescription.getText())) {
                    ...
                    if (!txtFacebook.getText().equals("https://")) {
                        if (!event.setFacebook(txtFacebook.getText())) {
                    ...
                    if (!txtTwitter.getText().equals("https://")) {
                        if (!event.setTwitter(txtTwitter.getText())) {
                    ...
                    try {
                        DesktopWrapper.getInstance().updateObject(event, DatabaseTable.PARENT_EVENT);
                        dispose();
                        parent.displayText("Success! " + event.getName() + " editted!");
